...
matrix3 = [[390, 201, 0, 0, 0, 0, 0, 0, 0, 0],
...
vector3 = [446, 62, -783, 264, -747, -732, -803, -716, -664, -608]
...
def expose_matrix_to_column(A, B): 
    resarr = [0] * len(B)
    for i in range(len(B)):
        suma = 0
        for j in range(len(B)):
